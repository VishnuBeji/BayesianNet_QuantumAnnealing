...
from solvers import exact_solver, dwave_solver
import generators.generator as gen
import generators.mhp_legacy as mhp_legacy
...
def main():
  ...
  generator_parser = subparsers.add_parser('generate',
                                           ...
                                           epilog='''Example: \'python -m Bayesian_QA generate problems/Alarm.json --size 10000 --expected\'
                                           will generate an expected dataset of size 10000 for the problem Alarm
                                           as datasets/Alarm.txt''')
  ...
  solver_parser = subparsers.add_parser('solve', help='estimate BN structure from data',
                                        description='',
                                        epilog='''Example: \'python -m Bayesian_QA solve Alarm.txt QA -r 10000 -a 99\'
                                        will use D-Wave\'s Quantum Annealer to solve the Alarm problem, with 10000 reads
